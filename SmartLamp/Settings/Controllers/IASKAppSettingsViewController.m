...
#pragma clang diagnostic pop
        ...
        if ([MFMailComposeViewController canSendMail]) {
            ...
            NSString *title = NSLocalizedString(@"Mail not configured", @"InAppSettingsKit");
            NSString *message = NSLocalizedString(@"This device is not configured for sending Email. Please configure the Mail settings in the Settings app.", @"InAppSettingsKit");
